...
import { Calendar, User, Receipt, ArrowRight, Monitor, ArrowLeft } from 'lucide-react';
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6 md:mb-8">
        <div>
          <div className="flex items-center gap-2 mb-2">
            <Link href="/penjualan" className="p-2 hover:bg-gray-100 rounded-lg border border-gray-200 text-gray-600 bg-white">
              <ArrowLeft className="w-4 h-4" />
            </Link>
            <h1 className="text-2xl font-bold text-black">Riwayat Penjualan</h1>
          </div>
          <p className="text-black font-semibold text-base">Daftar transaksi penjualan kardus yang telah dilakukan.</p>
        </div>
      </div>
